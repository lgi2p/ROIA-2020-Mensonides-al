...
class POS_data_handler(Abstract_data_handler):

    def __init__(self, file_with_data, POS_label_to_id_file, vocabulary_handler, batch_size):

        Abstract_data_handler.__init__(self)
        self.file_with_data = file_with_data
        self.vocabulary_handler = vocabulary_handler
        self.POS_label_to_id_file = POS_label_to_id_file
    ...
    def read_data(self):
        ...
        try:
            with io.open(self.POS_label_to_id_file, encoding='utf8') as f:
